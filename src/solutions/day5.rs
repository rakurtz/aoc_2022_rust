...
pub fn run() {
    ...
    // println!("Day 5, part 2 - {}", pt2_calculate(input.clone()));
}
...
impl Storage {
    ...
    fn move_crates_by_command_pattern(&mut self, command_pattern: String) {
...
fn pt1_calculate(input: String, amount_of_piles: usize) -> String {
    ...
    storage.move_crates_by_command_pattern(command_pattern);
...
move 1 from 1 to 2"
        ...
        assert_eq!("CMZ", pt1_calculate(input, 3));
    }
}
