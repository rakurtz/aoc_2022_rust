...
impl Elves {
    ...
    fn add_elve_from_vec_of_u32(&mut self, vec_of_u32: Vec<u32>)  {
        self.elves.push(Elve {calories: vec_of_u32.iter().sum()});
...
fn main() {
    ...
    println!("Day 1, part 1 - max calories by single elve carried: {}", elves.get_max_cal_carried_by_elve());
    println!("Day 1, part 2 - max calories by three elves carried: {}", elves.get_cal_carried_by_max_three_elve());
